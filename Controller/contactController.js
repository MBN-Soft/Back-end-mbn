...
const submitContactForm = async (req, res) => {
  try {
    ...
    // دعم service_type القديم و serviceType الجديد
    const selectedServiceType = serviceType || service_type;

    if (!name || !email || !message || !phone || !selectedServiceType) {
    ...
    const contactMessage = await prisma.contactMessage.create({
      data: {
        ...
        serviceType: String(selectedServiceType).trim(),
